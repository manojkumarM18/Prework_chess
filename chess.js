...
function changeDirection(queens, move) {
    var direction = queens.direction;
    switch (direction) {
        case 'S':
        case 's':
            moveForward(queens.position, direction, move);
            break;
        case 'N':
        case 'n':
            moveBackward(queens.position, direction, move);
            break;
